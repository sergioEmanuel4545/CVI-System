...
app.use(
  session({
    //configuraciones basicas de modulo sessions
    secret: "mysecretapp",
    resave: true,
...
app.use((req, res, next) => {
  ...
  if (
    res.locals.currentURL !== "/inventarios/existencias" &&
    res.locals.currentURL !== "/inventarios/historial" &&
    res.locals.currentURL !== "/inventarios/categorias" &&
    res.locals.currentURL !== "/inventarios/mopos" &&
